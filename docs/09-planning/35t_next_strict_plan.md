...
生成日期：2026-05-20
建议放置路径：`docs/09-planning/35t_next_strict_plan.md`
...
```text
docs/03-platform-architecture/artix7-35t/artix7_35t_trace_profiles.md
```
...
| 检查项 | PASS 条件 |
| --- | --- |
| 文档存在 | `docs/03-platform-architecture/artix7-35t/artix7_35t_trace_profiles.md` 存在。 |
...
```text
docs/07-evaluation-evidence/reports/artix7_35t_resource_report.md
```
...
```text
1. 新增 docs/03-platform-architecture/artix7-35t/artix7_35t_trace_profiles.md。

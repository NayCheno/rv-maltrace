...
```text
docs/results/rv_maltrace_35t_application_closure.md
...
```text
docs/results/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/
```
...
- [ ] `docs/results/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/` 存在。
...
- [ ] `docs/results/rv_maltrace_35t_application_closure.md` 中的 evidence path 更新为优先指向 committed snapshot。
...
```text
docs/results/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/application_closure_check.json
docs/results/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/application_closure_check.md
```
...
uv run python tools/check_35t_application_closure.py \
  --repo-root . \
  --evidence-root docs/results/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521
```

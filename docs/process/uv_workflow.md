...
The generated report is `docs/reports/resource_report.md`. When
...
bare-metal runtime observations are still recorded in `docs/board/board_bringup.md`.
...
Phase 4.3 is documented in `docs/board/baseline_bringup_runbook.md`. The runbook
...
Phase 4.4 is tracked in `docs/board/baseline_pass_criteria.md`. The checker keeps
...
Phase 5.1 is tracked in `docs/architecture/trace_export_decision.md`. The first board export
...
Phase 5.2 is tracked in `docs/board/board_trace_minimal.md`. The first board trace
...
Phase 5.3 is tracked in `docs/board/board_trace_validation.md` and
...
Phase 6.1 is tracked in `docs/linux/linux_behavior_experiment_principles.md` and
...
Phase 6.2 is tracked in `docs/linux/linux_benign_dataset.md` and
...
Phase 6.3 is tracked in `docs/linux/linux_malware_like_dataset.md` and
...
Phase 6.4 is tracked in `docs/linux/linux_behavior_recovery_targets.md` and
...
Phase 6.5 is tracked in `docs/linux/linux_behavior_audit.md` and
...
The behavior demo is tracked in `docs/linux/behavior_demo.md`. It stitches a checked
...
Phase 3.4 is tracked in `docs/validation/noninterference_resource_gate.md` and
...
Phase 9.1 is tracked in `docs/research/lightweight_trace_analysis.md` and
...
Phase 10.1 is tracked in `docs/research/isa_behavior_portability.md` and
...
Phase 7.1 is tracked in `docs/research/semantic/semantic_enrichment_rationale.md` and
...
Phase 7.2 is tracked in `docs/research/semantic/semantic_enrichment_routes.md` and
...
Phase 7.3 is tracked in `docs/research/semantic/semantic_enrichment_strategy.md` and
...
Paper-level evaluation planning is tracked in `docs/research/evaluation_plan.md`. It

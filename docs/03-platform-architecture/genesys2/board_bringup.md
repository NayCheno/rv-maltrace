...
Phase 4.2 is recorded in `docs/03-platform-architecture/genesys2/vivado_authorization.md`.
...
Phase 4.3 is the ordered board procedure in `docs/03-platform-architecture/genesys2/baseline_bringup_runbook.md`.
...
Phase 4.4 is tracked in `docs/03-platform-architecture/genesys2/baseline_pass_criteria.md`. Current status:
...
Phase 5.1 export choice is recorded in `docs/02-trace-architecture/trace_export_decision.md`.

...
| Board clock/reset stable | TODO (BOARD) | `01_led_clock_reset/observation.md` with PASS plus programming transcript or board observation artifact | `docs/03-platform-architecture/genesys2/baseline_bringup_runbook.md` |
| UART output visible | TODO (BOARD) | `02_uart_hello/observation.md` with PASS plus raw UART log | `docs/03-platform-architecture/genesys2/baseline_bringup_runbook.md` |
| Bare-metal program can run | TODO (BOARD) | `04_cva6_baremetal_boot/observation.md` with PASS plus UART/tohost/JTAG log showing the expected end state | `docs/03-platform-architecture/genesys2/baseline_bringup_runbook.md` |

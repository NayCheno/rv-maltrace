...
| Board clock/reset stable | PASS | `01_led_clock_reset/observation.md` with PASS plus programming transcript or board observation artifact | `docs/03-platform-architecture/genesys2/baseline_bringup_runbook.md` |
| UART output visible | PASS | `02_uart_hello/observation.md` with PASS plus raw UART log | `docs/03-platform-architecture/genesys2/baseline_bringup_runbook.md` |

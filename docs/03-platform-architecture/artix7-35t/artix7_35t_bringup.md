...
| Source | Use |
| --- | --- |
| `docs/03-platform-architecture/artix7-35t/artix7_35t_pinmap.xlsx` | Pin map for clock, DDR3, reset, keys, LEDs, USB-UART, SD, and other peripherals |
| `docs/03-platform-architecture/artix7-35t/artix8_35t_hw_spec.pdf` | Hardware specification currently present in this repository |

The user referred to `docs/03-platform-architecture/genesys2/artix7_35t_hw_spec.pdf`, but the current
repository file is named `docs/03-platform-architecture/artix7-35t/artix8_35t_hw_spec.pdf`. Treat that PDF as
...
stage. Record exact versions in `docs/10-process/version_lock.md` or a future
...
3. Keep CVA6 signal semantics intact; do not weaken
   `docs/02-trace-architecture/signal_map.md` to fit LiteX.

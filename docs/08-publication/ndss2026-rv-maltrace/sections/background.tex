...
\centering
\scriptsize
\begin{tabularx}{\textwidth}{@{}p{0.14\textwidth}p{0.07\textwidth}p{0.09\textwidth}p{0.08\textwidth}p{0.11\textwidth}p{0.08\textwidth}Y@{}}
\toprule
...
\bottomrule
\end{tabularx}
\caption{Related-work comparison. Arch. = architecture; Perturb. = perturbation level; Sem. Rec. = semantic reconstruction; Prov. = provenance labeling; Open = open-source core and trace logic.}

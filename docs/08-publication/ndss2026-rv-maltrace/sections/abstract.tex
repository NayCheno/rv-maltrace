...
reproducible artifact package rooted at \artifactroot. It evaluates trace
ordering, syscall pairing, source labeling, code attribution, and local
reproduction. The paper does not report real-malware validation, production
streaming/DMA throughput, JTAG RAM boot, SD-card-free kernel update, or
cycle-level board overhead.
\end{abstract}

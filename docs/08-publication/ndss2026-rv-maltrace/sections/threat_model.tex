...
We evaluate behavior reconstruction and observer-boundary evidence, not malware
detection accuracy. We do not evaluate uncontrolled real malware, production
streaming throughput, or cycle-level trace-off versus trace-on slowdown. These
boundaries are summarized in Table~\ref{tab:scope}.

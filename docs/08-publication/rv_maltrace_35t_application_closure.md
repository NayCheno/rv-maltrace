...
docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/sample_matrix_summary.md
docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/case_study_artifact_index.json
docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/function_attribution_summary.md
docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/source_attribution_summary.md
docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/explanation_readiness_summary.md
docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/board_validation_attempt_summary.md
docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/board_validation_plan.md
docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/board_validation_preflight.md
docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/board_validation_runbook.md
docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/board_validation_status.md

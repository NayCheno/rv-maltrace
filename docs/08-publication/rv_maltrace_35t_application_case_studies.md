...
```text
docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/process_tree_summary.md
```
...
```text
docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/fd_path_flow_summary.md
```

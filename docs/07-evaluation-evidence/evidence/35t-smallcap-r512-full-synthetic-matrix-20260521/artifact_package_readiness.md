...
| `resource_timing_reports` | `READY_PUBLIC_SUMMARY_OR_HASH` | 4/3 | `public_summary` | 10756 |
| `elf_hashes` | `READY_PUBLIC_SUMMARY_OR_HASH` | 39/13 | `public_hashes` | 6864 |
| `bitstream_metadata` | `READY_PUBLIC_SUMMARY_OR_HASH` | 4/1 | `public_summary_no_bitstream_binary` | 12614 |
| `scripts_and_commands` | `READY_PUBLIC` | 40/4 | `public` | 1166113 |
...
| `qemu_plugin_baseline_evidence` | `READY_PUBLIC_SUMMARY_OR_HASH` | 3/3 | `public_summary` | 139554 |
| `raw_artifact_sanitization_evidence` | `READY_PUBLIC` | 2/2 | `public` | 15500 |
| `pointer_snapshot_design_review_evidence` | `READY_PUBLIC` | 4/4 | `public` | 11503 |
| `raw_artifact_escrow_package` | `READY_LOCAL_ONLY` | 6/6 | `local_only_raw_or_sanitized_excerpt` | 94901 |
| `negative_failed_cases` | `READY_PUBLIC_SUMMARY_OR_HASH` | 9/3 | `public_summary` | 316430 |
| `reproduction_readme` | `READY_PUBLIC` | 3/2 | `public` | 160302 |

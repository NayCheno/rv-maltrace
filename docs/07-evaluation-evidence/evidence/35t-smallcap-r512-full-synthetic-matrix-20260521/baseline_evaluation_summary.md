...
| `ebpf_only` | `PASS` | 13/13 | docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/ebpf_baseline_summary.json |
| `qemu_plugin` | `PASS` | 13/13 | docs/07-evaluation-evidence/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/qemu_plugin_baseline_summary.json |

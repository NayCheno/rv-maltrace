...
- surrogate_boot_log_not_run_scoped: Surrogate run has board/raw UART and sample artifacts, but no separate Linux boot log under results/board for that run_id; see docs/07-evaluation-evidence/evidence/35t-surrogate-boot-provenance-20260524 for the recorded blocker and capture runbook.

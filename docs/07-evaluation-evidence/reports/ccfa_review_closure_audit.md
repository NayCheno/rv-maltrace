...
- Non-real external items accepted: 0
- Non-real external items still blocked: 4
...
| --- | --- | --- |
| `full_hardware_pointer_strings` | `EXTERNAL_SUMMARY_PRESENT_INVALID` | `results/evaluation/genesys2-cva6/current/external_closure/hardware_pointer_strings_summary.json` |
| `board_native_dwarf_source_lines` | `EXTERNAL_SUMMARY_PRESENT_INVALID` | `results/evaluation/genesys2-cva6/current/external_closure/board_native_source_lines_summary.json` |
| `genesys2_board_benign_control` | `EXTERNAL_SUMMARY_PRESENT_INVALID` | `results/evaluation/genesys2-cva6/current/external_closure/board_benign_control_summary.json` |

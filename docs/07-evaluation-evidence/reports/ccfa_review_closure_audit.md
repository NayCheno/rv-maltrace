...
Status: `PASS`
Closure status: `PASS_LOCAL_SCOPE_EXTERNAL_OPEN`
...
- Local/current items closed: 11
- Non-real external items still open: 4
...
| --- | --- | --- |
| `full_hardware_pointer_strings` | `OPEN_NO_EXTERNAL_SUMMARY` | `results/evaluation/genesys2-cva6/current/external_closure/hardware_pointer_strings_summary.json` |
| `board_native_dwarf_source_lines` | `OPEN_NO_EXTERNAL_SUMMARY` | `results/evaluation/genesys2-cva6/current/external_closure/board_native_source_lines_summary.json` |
| `genesys2_board_benign_control` | `OPEN_NO_EXTERNAL_SUMMARY` | `results/evaluation/genesys2-cva6/current/external_closure/board_benign_control_summary.json` |
| `production_streaming_dma_trace_sink` | `OPEN_NO_EXTERNAL_SUMMARY` | `results/evaluation/genesys2-cva6/current/external_closure/streaming_dma_throughput_summary.json` |

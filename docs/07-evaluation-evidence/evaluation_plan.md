...
| RQ5 | Hardware cost: what are LUT, FF, BRAM, Fmax, trace bandwidth, and drop-rate costs? | Vivado utilization/timing reports, `docs/07-evaluation-evidence/reports/resource_report.md`, trace bandwidth summaries, and drop accounting | TODO |

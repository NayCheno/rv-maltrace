...
Readiness: `LIGHTWEIGHT_PACKAGE_READY_FULL_REPRO_DEFERRED` from `docs/results/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/artifact_package_readiness.json`

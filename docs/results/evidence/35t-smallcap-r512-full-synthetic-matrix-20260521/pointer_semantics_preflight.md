...
- sim_results: `docs/reports/sim_results.md`
...
- side_channel: `docs/results/evidence/35t-smallcap-r512-full-synthetic-matrix-20260521/board_syscall_side_channel_smoke.json`

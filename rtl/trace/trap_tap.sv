...
(
  ...
  assign trace_valid_o = trap_valid_i;

  always_comb begin
    trace_packet_o = trace_null_packet();
    trace_packet_o.valid = trace_valid_o;
    trace_packet_o.evt   = trace_valid_o ? EVT_TRAP : EVT_NONE;
    trace_packet_o.cycle = cycle_i;
    trace_packet_o.pc    = trap_pc_i;
    trace_packet_o.cause = trap_cause_i;
    trace_packet_o.tval  = trap_tval_i;

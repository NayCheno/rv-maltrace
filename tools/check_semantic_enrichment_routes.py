...
DEFAULT_DOC = Path("docs/05-semantic-analysis/semantic_enrichment_routes.md")
DEFAULT_TRACE_FORMAT = Path("docs/02-trace-architecture/trace_format.md")
...
def check_uv_doc(path: Path) -> list[str]:
    ...
    for token, label in (
        ...
        ("docs/05-semantic-analysis/semantic_enrichment_routes.md", "Phase 7.2 doc reference"),
...
""",
    ...
    (root / DEFAULT_UV_DOC).write_text(
        ...
        "docs/05-semantic-analysis/semantic_enrichment_routes.md\n"
        "experiments/linux_behavior/semantic_enrichment_routes.json\n",
        encoding="utf-8",
    )
...
def self_test() -> int:
    ...
    for token, expected in (
        ...
        ("docs/05-semantic-analysis/semantic_enrichment_routes.md", "doc reference"),

...
def check_uv_doc(path: Path) -> list[str]:
    ...
    for token, label in (
        ...
        ("docs/05-semantic-analysis/semantic_enrichment_strategy.md", "Phase 7.3 doc reference"),
...
""",
    ...
    (root / DEFAULT_UV_DOC).write_text(
        ...
        "docs/05-semantic-analysis/semantic_enrichment_strategy.md\n"
        "experiments/linux_behavior/semantic_enrichment_strategy.json\n",
        encoding="utf-8",
    )
...
def self_test() -> int:
    ...
    for token, expected in (
        ...
        ("docs/05-semantic-analysis/semantic_enrichment_strategy.md", "doc reference"),

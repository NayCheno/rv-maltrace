...
BENIGN_SAMPLES = {
    ...
    "pid_status": "direct_syscall_getpid_getppid_write",
    "clock_status": "direct_syscall_clock_gettime_write",
    "write_twice": "direct_syscall_two_stdout_writes",
    "open_tmp_close": "direct_syscall_openat_tmp_close_write",
    "getdents_only": "direct_syscall_openat_getdents64_close_write",
    "read_twice": "direct_syscall_openat_two_reads_write_close",
    "mmap_rw": "direct_syscall_mmap_readwrite_write_munmap",
    "readlink_self": "direct_syscall_readlinkat_self_write",
    "prctl_get_name": "direct_syscall_prctl_get_name_write",
    "pid_clock_mix": "direct_syscall_getpid_clock_gettime_write",
    "cat_small": "direct_syscall_openat_small_read_write_close",
    "getpid_only": "direct_syscall_getpid_write",
    "getppid_only": "direct_syscall_getppid_write",
    "clock_twice": "direct_syscall_two_clock_gettime_write",
    "prctl_set_name": "direct_syscall_prctl_set_name_write",
    "prctl_set_get_name": "direct_syscall_prctl_set_get_name_write",
    "open_read_close": "direct_syscall_openat_read_close",
    "open_write_close": "direct_syscall_openat_write_close",
    "read_zero": "direct_syscall_openat_zero_length_read_close",
    "mmap_double": "direct_syscall_two_mmap_write_two_munmap",
    "mmap_munmap_only": "direct_syscall_mmap_munmap",
    "readlink_twice": "direct_syscall_two_readlinkat_write",
    "open_proc_status": "direct_syscall_proc_self_status_read_close",

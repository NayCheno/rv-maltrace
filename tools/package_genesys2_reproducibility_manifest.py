...
SUMMARY_ARTIFACTS = [
    ...
    ("hardware_trace_cycle_window", "hardware_trace_cycle_window_summary.json", "uv run python tools/check_genesys2_hardware_trace_cycle_window.py --root ."),
...
TRUTHFUL_NONPASS_STATUSES = {
    ...
    "PASS_LIVE_KERNEL_CONFIG_EXPORTED",

...
DEFAULT_SOURCE = Path("board/trace_validation/programs/cycle_counter_smoke.c")
DEFAULT_OUT_ROOT = Path("build/board/genesys2_cycle_counter_smoke")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build the Genesys2/CVA6 rdcycle cycle-counter smoke ELF inside Docker.")
    ...
    binary = out_root / "cycle_counter_smoke.riscv64"
    ...
    row = {
        "schema": "rvmt.genesys2.cycle_counter_smoke_build.v1",
        "status": "PASS",
